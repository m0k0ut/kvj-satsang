...
export const pageCopy = {
  te: {
    ...
    about: {
      eyebrow: 'వ్యవస్థాపకురాలు మరియు గురువు', title: 'విద్య, భక్తి, సేవలతో సార్థకమైన జీవితం', description: 'KVJ సత్సంగం వ్యవస్థాపకురాలు, ప్రధాన గురువు, ఆధ్యాత్మిక మార్గదర్శి రాధా మేడం పరిచయం.',
    },
    classes: {
